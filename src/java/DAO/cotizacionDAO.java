...
public class cotizacionDAO {
    ...
    public List<Object[]> listarCotizaciones() {
        ...
        String sql = "SELECT"
                ...
                + "	Cot.Tipo_Cotizacion,"
                + "    Cot.Ubicacion,"
                + "    Cot.Fecha_Parcial_Evento_Cotización,"
                + "    Cot.Fecha_Hora_Cotizacion,"
                + "    Cot.Valor_Cotización,"
                + "    Cot.Cantidad_Personas_Cotización,"
                + "    Cot.Cotizante_Correo,"
                + "    Ctz.Nombre_Cotizante,"
                + "    Ctz.Apellido_Cotizante,"
                + "    Ctz.Telefono_Cotizante,"
                + "    Ser.idServicio,"
                + "    Ser.Valor_Servicio,"
                + "    Ser.Tipo_Servicio,"
                + "    Ser.Descripcion_servicio"
                + "FROM "
                + "    Cotización AS Cot"
                + "JOIN "
                + "    Cotizante AS Ctz ON Cot.Cotizante_Correo = Ctz.Correo_Cotizante"
                + "JOIN "
                + "    Cotizacion_Servicio AS CS ON Cot.No_Cotizacion = CS.Cotizacion_No_Cotizacion"
                + "JOIN "
                + "    Servicio AS Ser ON CS.Servicio_idServicio = Ser.idServicio;";
        try {
